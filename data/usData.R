...
#import
data <- read.csv("~/Desktop/Data Viz - Project 1/Project/data/SC-EST2014-AGESEX-CIV.csv", header = TRUE)
...
#add state
data <- read.csv("C:/wamp/www/viz/data/SC-EST2014-AGESEX-CIV-usa states.csv", header=TRUE)
